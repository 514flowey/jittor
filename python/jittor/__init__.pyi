...
from . import amp as amp, autograd as autograd, compile_extern as compile_extern, compiler as compiler, dataset as dataset, distributions as distributions, fft as fft, init as init, linalg as linalg, math_util as math_util, misc as misc, nn as nn, optim as optim, sparse as sparse
...
#   zeros
#   zeros_like
from typing import Any, Callable, ContextManager, List, Optional, Tuple, overload
import numpy
...
class Var:
	...
	# remain optional runtime metadata and do not alter native Var semantics.
	def to_device(self, index: int) -> Var: ...
	def _copy_to_cpu(self) -> Var: ...
	_jittor_torch_force_cpu: bool
	_jittor_torch_force_cuda: bool
	def __add__(self, other: object) -> Var: ...
	def __radd__(self, other: object) -> Var: ...
	def __sub__(self, other: object) -> Var: ...
	def __rsub__(self, other: object) -> Var: ...
	def __mul__(self, other: object) -> Var: ...
	def __rmul__(self, other: object) -> Var: ...
...
def graph_replay(module, *example_inputs):
    """Re-run a captured inference graph instead of rebuilding it each call."""
    ...
